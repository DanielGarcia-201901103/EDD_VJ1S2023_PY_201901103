...
export const LoginEmpleados = () => {
    ...
    return (
        ...
        <Card.Body>
            ...
            <Form>
            <Button className="w-100 btn btn-lg btn-primary" onClick={alert("Pendiente1")}>
                Cargar Pedidos
            </Button>
            <br/>
            <Button className="w-100 btn btn-lg btn-primary" onClick={alert("Pendiente2")}>
                Cargar Empleados
            </Button>
            <br/>
            <Button className="w-100 btn btn-lg btn-primary" onClick={alert("Pendiente3")}>
                Reportes
            </Button>
            </Form>
        </Card.Body>
